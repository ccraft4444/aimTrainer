...
class TitleScreen():
    ...
    def update(self):
        ...
        press_space_rect.centerx, press_space_rect.centery = self.display_surface.get_rect().centerx, self.display_surface.get_rect().centery
